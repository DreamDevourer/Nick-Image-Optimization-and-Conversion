...
_recipes_pil_prescript(['PalmImagePlugin', 'IcoImagePlugin', 'FpxImagePlugin', 'PdfImagePlugin', 'PcxImagePlugin', 'FliImagePlugin', 'TgaImagePlugin', 'BlpImagePlugin', 'WebPImagePlugin', 'PsdImagePlugin', 'MpoImagePlugin', 'CurImagePlugin', 'GifImagePlugin', 'MicImagePlugin', 'TiffImagePlugin', 'GbrImagePlugin', 'ImtImagePlugin', 'JpegImagePlugin', 'SpiderImagePlugin', 'DdsImagePlugin', 'GribStubImagePlugin', 'DcxImagePlugin', 'McIdasImagePlugin', 'Hdf5StubImagePlugin', 'BmpImagePlugin', 'MspImagePlugin', 'EpsImagePlugin', 'Jpeg2KImagePlugin', 'ImImagePlugin', 'IptcImagePlugin', 'XbmImagePlugin', 'PcdImagePlugin', 'SunImagePlugin', 'IcnsImagePlugin', 'FitsStubImagePlugin', 'FtexImagePlugin', 'SgiImagePlugin', 'BufrStubImagePlugin', 'PngImagePlugin', 'PpmImagePlugin', 'XpmImagePlugin', 'WmfImagePlugin', 'XVThumbImagePlugin', 'MpegImagePlugin', 'PixarImagePlugin'])
...
DEFAULT_SCRIPT='Nick - Image Optimization and Conversion.py'
SCRIPT_MAP={}
_run()
